    ...
    public partial class PruebaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=tecbet.database.windows.net;Initial Catalog=Test;User ID=alfonso;Password=Abadacra2014;Connect Timeout=30;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False;MultipleActiveResultSets=true");
                optionsBuilder.UseSqlServer("Data Source = keycloud - prod.database.windows.net; initial catalog = Produccion; Connection Timeout = 30; User Id = appkey; Password = Kkdbc36de$; Min Pool Size = 20; Max Pool Size = 200; ");
